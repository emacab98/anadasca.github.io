...
$(document).ready(function () {
  ...
  $("#my_a_avatar").click(function () {
    ...
    $("#change").click(function () {
      ...
      if (image == "Uncle Vernon")
        img_src = "../Images/Avatars_images/vern1.jpg";
      else if (image == "Aunt Petunia")
        img_src = "../Images/Avatars_images/pet1.jpg";
      else if (image == "Jacob Kowalski")
        img_src = "../Images/Avatars_images/kowalski2.JPG";
